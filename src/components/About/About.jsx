    ...
    <div className="about">
      <div className="about-flex">
        <div className="item">
          ...
          <p>
          Saveetha Engineering College (SEC) was established in 2001, by the Founder President Dr N.M Veeriayan, a committed and dedicated Medical Professional. SEC has 13 UG courses & 7 PG courses including MBA, Doctoral Programs (Ph.D.) in five Departments. The college is autonomous under Anna University, accredited by NAAC with ‘A’ Grade. NBA accreditation for UG Courses in IT, CSE, ECE, EEE, Mechanical Engineering and has been certified for ISO 9001-2000 by BVQI. SEC has Five Research Centres recognized by Anna University, MOU with reputed academic institutions in India and abroad.
          </p>
        </div>
        <div className="item">
